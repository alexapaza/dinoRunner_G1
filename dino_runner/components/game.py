...
class Game():
    ...
    def show_menu(self):
        ...
        whithe_color = (255,255,255)
        self.screen.fill(whithe_color)
    ...
    def print_menu_elements(self, death_count =0):
        ...
        if death_count ==0:
            ...
            death, death_rect = get_centered_message('your life is: ' + str(self.death_count),heigth = half_screen_height + 100)
