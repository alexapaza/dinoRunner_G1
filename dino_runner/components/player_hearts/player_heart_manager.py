...
class PlayerHeartManager:
    ...
    def draw(self, screen):
        ...
        for count in range(self.heart_count):  # nose decifro el origen correcto pero la solucion fue sumarle 1, a menos que el rango saque 4 desde la posicion inicial
